...
import org.apache.hc.core5.http.protocol.HttpContext;   // XXX
import org.apache.hc.core5.http.protocol.LookupRegistry;   // XXX
import org.apache.hc.core5.http.protocol.UriPatternMatcher;   // XXX
import org.apache.hc.core5.http.protocol.UriPatternType;   // XXX
...
public class RequestHandlerRegistry<T> implements HttpRequestMapper<T> {
    ...
    // >>> modified from org.apache.hc.core5.http.protocol.RequestHandlerRegistry
    private LookupRegistry<T> getPatternMatcher(final String hostname) {
        if (virtualMap.containsKey(hostname))
